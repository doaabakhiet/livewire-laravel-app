...
@section('content')
    <div class="card">
        <div class="card-body">
            ...
            {{ Form::model(null,['route' => ['dashboard.users.store'], 'method' => 'POST', 'class' => 'forms-sample']) }}
            @csrf
            ...
            <div class="form-check form-check-primary">
                <label class="form-check-label">
                    {{ Form::checkbox('role_as','1', array_merge(['class' => 'form-check-input','style'=>'height:40px;width:40px;'])) }}
                    Is Admin

                    ...
                    <div class="col-md-12">
                                        ...
                                        <div class="tab-content col-md-9" id="v-pills-tabContent">
                                            <div class="tab-pane fade" id="cashOnDeliveryTab" role="tabpanel"
                                                ...
                                                <button type="button" wire:loading.attr="disabled"
                                                    wire:click="cachOnDeliveryOrder" class="btn btn-primary">
                                                    <span wire:loading.remove wire:target="cachOnDeliveryOrder">
                                                        Place Order (Cash on
                                                        Delivery)
                                                    </span>
                                                    <span wire:loading wire:target="cachOnDeliveryOrder">
                                                        Placing Order
                                                    </span>
                                                </button>
                        ...
                        @else
                            <div class="row">
                                <div class="col-md-12 mb-4">
                                    <div class="shadow bg-white p-3">
                                        No item In Cart To Checkout
                                        <span><a href="{{ url('categories') }}" class="btn btn-primary w-100">Shop
                                                Now</a></span>
                                    </div>
                                </div>
                            </div>
...
@push('javascript')
    ...
    <script
        src="https://www.paypal.com/sdk/js?client-id=AVU_TpsFqGp9-c0ixbZpizAXsrBw7Dnzq83NxcOX0f30W-90FweHxHP0juxi74jXGlCMgWWjYPvr_z_8&currency=USD">
    </script>
    ...
    <script>
        paypal.Buttons({
            ...
            //    actions.disable();
                ...
                // $document.getElementById('address').on('change', function() {
                //     alert(2);
                    // if ($document.getElementById('address').val()) { alert(2);
            ...
            onClick: function() {
                if (!document.getElementById('full_name').value ||
                    ...
                    Livewire.emit('ValidationPaymentForm');
                    return false;
                } else {

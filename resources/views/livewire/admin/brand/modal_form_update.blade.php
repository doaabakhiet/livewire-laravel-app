<div wire:ignore.self class="modal fade " id="updateBrand" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div wire:loading.remove class="modal-body">
                ...
                {{ Form::model(null, ['wire:submit.prevent' => 'update()', 'class' => 'forms-sample']) }}
                {{-- @csrf --}}
                ...
                <div class="form-check form-check-primary">
                    <label class="form-check-label">
                        ...
                        {{ Form::checkbox('status',null, false,array_merge(['wire:model.defer' => 'status', 'class' => 'form-check-input'])) }}
                        Status
